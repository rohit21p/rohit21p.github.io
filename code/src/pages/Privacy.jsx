          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 md:p-12 border border-gray-700 space-y-8 text-gray-300">
            ...
            <div>
              ...
              <p className="leading-relaxed">
                At NexPay, we are committed to protecting your privacy and ensuring the security of your personal information. 
                This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our 
                device financing platform and services.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Financial information (bank account details, credit history)</li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Processing and managing financing applications</li>
                <li>Verifying your identity and creditworthiness</li>
                <li>Managing device financing agreements and payments</li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>Partner Retailers:</strong> To facilitate device financing transactions</li>
            ...
            <div>
              ...
              <p className="leading-relaxed">
                ...
                cookies may limit certain features of our services.
              </p>
            </div>
